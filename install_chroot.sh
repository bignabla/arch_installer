...
hwclock --systohc
# Don't forget to change "Europe/Rome" with your own timezone!
...
# Don't forget to replace "bignabla" by the username of your Github account!
dialog --title "Continue installation" --yesno \
"Do you want to install all your apps and your dotfiles?" \
10 60 \
&& curl https://raw.githubusercontent.com/bignabla\
